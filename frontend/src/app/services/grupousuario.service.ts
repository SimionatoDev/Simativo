...
constructor(private http: HttpClient) {}
	...
	getGrupousuario(id_empresa:number,id_grupos_user:number): Observable<GrupousuarioModel> { 
 		return this.http.get<GrupousuarioModel >(`${ this.apiURL}grupousuario/${id_empresa}/${id_grupos_user}`);
	}
	...
	grupousuarioDelete(id_empresa:number,id_grupos_user:number):Observable<any>  { 
 		return this.http.delete<any>(`${this.apiURL}grupousuario/${id_empresa}/${id_grupos_user}`);
	}
}