...
constructor(private http: HttpClient) {}
	...
	getEmpresa(id_empresa:number): Observable<EmpresaModel> { 
 		return this.http.get<EmpresaModel >(`${ this.apiURL}empresa/${id_empresa}`);
	}
	...
	empresaDelete(id_empresa:number):Observable<any>  { 
 		return this.http.delete<any>(`${this.apiURL}empresa/${id_empresa}`);
	}
}