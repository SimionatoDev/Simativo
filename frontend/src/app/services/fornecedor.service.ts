...
constructor(private http: HttpClient) {}
	...
	getFornecedor(id_empresa:number,id_fornecedor:number): Observable<FornecedorModel> { 
 		return this.http.get<FornecedorModel >(`${ this.apiURL}fornecedor/${id_empresa}/${id_fornecedor}`);
	}
	...
	fornecedorDelete(id_empresa:number,id_fornecedor:number):Observable<any>  { 
 		return this.http.delete<any>(`${this.apiURL}fornecedor/${id_empresa}/${id_fornecedor}`);
	}
}