...
constructor(private http: HttpClient) {}
	...
	getValor(id_empresa:number,id_ativo:number,id_valor:number,id_caracteristica:number): Observable<ValorModel> { 
 		return this.http.get<ValorModel >(`${ this.apiURL}valor/${id_empresa}/${id_ativo}/${id_valor}/${id_caracteristica}`);
	}
	...
	valorDelete(id_empresa:number,id_ativo:number,id_valor:number,id_caracteristica:number):Observable<any>  { 
 		return this.http.delete<any>(`${this.apiURL}valor/${id_empresa}/${id_ativo}/${id_valor}/${id_caracteristica}`);
	}
}