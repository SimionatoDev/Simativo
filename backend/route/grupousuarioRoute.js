...
router.get("/api/grupousuario/:id_empresa/:id_grupos_user",async function(req, res) {
try 
	{
		const lsLista = await grupousuarioSrv.getGrupousuario(req.params.id_empresa,req.params.id_grupos_user);
		if (lsLista == null) 
		{
...
router.delete("/api/grupousuario/:id_empresa/:id_grupos_user",async function(req, res) {
try 
	{
		await grupousuarioSrv.deleteGrupousuario(req.params.id_empresa,req.params.id_grupos_user);
