...
/* ROTA GETONE empresa */
router.get("/api/empresa/:id_empresa",async function(req, res) {
try 
	{
		const lsLista = await empresaSrv.getEmpresa(req.params.id_empresa);
		if (lsLista == null) 
		{
...
/* ROTA DELETE empresa */
router.delete("/api/empresa/:id_empresa",async function(req, res) {
try 
	{
		await empresaSrv.deleteEmpresa(req.params.id_empresa);
