...
router.get("/api/fornecedor/:id_empresa/:id_fornecedor",async function(req, res) {
try 
	{
		const lsLista = await fornecedorSrv.getFornecedor(req.params.id_empresa,req.params.id_fornecedor);
		if (lsLista == null) 
		{
...
router.delete("/api/fornecedor/:id_empresa/:id_fornecedor",async function(req, res) {
try 
	{
		await fornecedorSrv.deleteFornecedor(req.params.id_empresa,req.params.id_fornecedor);
