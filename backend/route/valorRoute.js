...
/* ROTA GETONE valor */
router.get("/api/valor/:id_empresa/:id_ativo/:id_valor/:id_caracteristica",async function(req, res) {
try 
	{
		const lsLista = await valorSrv.getValor(req.params.id_empresa,req.params.id_ativo,req.params.id_valor,req.params.id_caracteristica);
		if (lsLista == null) 
		{
...
/* ROTA DELETE valor */
router.delete("/api/valor/:id_empresa/:id_ativo/:id_valor/:id_caracteristica",async function(req, res) {
try 
	{
		await valorSrv.deleteValor(req.params.id_empresa,req.params.id_ativo,req.params.id_valor,req.params.id_caracteristica);
