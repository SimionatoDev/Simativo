...
/* CRUD GET SERVICE */
exports.getFornecedor = async function(id_empresa,id_fornecedor){
	return fornecedorData.getFornecedor(id_empresa,id_fornecedor);
};
...
//* CRUD - DELETE - SERVICE */
 exports.deleteFornecedor = async function(id_empresa,id_fornecedor){
try 
{
	await  regras.fornecedor_Exclusao(id_empresa,id_fornecedor);
	return fornecedorData.deleteFornecedor(id_empresa,id_fornecedor);
}
catch (err)
{ 
	throw new erroDB.UserException(err.erro, err); 
