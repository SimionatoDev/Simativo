...
/* CRUD GET SERVICE */
exports.getGrupousuario = async function(id_empresa,id_grupos_user){
	return grupousuarioData.getGrupousuario(id_empresa,id_grupos_user);
};
...
//* CRUD - DELETE - SERVICE */
 exports.deleteGrupousuario = async function(id_empresa,id_grupos_user){
try 
{
	await  regras.grupousuario_Exclusao(id_empresa,id_grupos_user);
	return grupousuarioData.deleteGrupousuario(id_empresa,id_grupos_user);
}
catch (err)
{ 
	throw new erroDB.UserException(err.erro, err); 
