...
/* CRUD GET SERVICE */
exports.getUsuario = async function(id_empresa,id_usuario){
	return usuarioData.getUsuario(id_empresa,id_usuario);
};
...
//* CRUD - DELETE - SERVICE */
 exports.deleteUsuario = async function(id_empresa,id_usuario){
try 
{
	await  regras.usuario_Exclusao(id_empresa,id_usuario);
	return usuarioData.deleteUsuario(id_empresa,id_usuario);
}
catch (err)
{ 
	throw new erroDB.UserException(err.erro, err); 
